...
from SweetyMusic.utils.database import get_authuser_names, get_cmode
from SweetyMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from SweetyMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Sweety.stop_stream(message.chat.id)
    except:
        pass
