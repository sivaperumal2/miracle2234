...
# Owner Sambodhiraj
# All rights reserved. © Alisha © Sweety
...
from SweetyMusic.utils import (Sweetybin, get_channeplayCB,
                              seconds_to_min)
from SweetyMusic.utils.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from SweetyMusic.utils.decorators.language import language, languageCB
from SweetyMusic.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://telegra.ph/file/1ce14dc68705d71fe107c.jpg",
        caption=_["queue_1"],
    )
